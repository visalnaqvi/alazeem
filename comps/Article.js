...
const Article = ({headingcenter ,headingnormal, heading , text  , textcenter , pheadingcenter}) => {
    return ( 
        
 
            <div className={style.article}>
                {headingcenter&&<h2 className={style.articletitlecenter}>{headingcenter}</h2>}
                {pheadingcenter&&<h2 className={style.articletitlecenter}>{pheadingcenter}</h2>}
