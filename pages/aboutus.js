...
const AboutUs = () => {
    ...
    />
        ...
        <Hero img="url(/_next/static/media/aboutus.b3d0c544.webp)" heading="PASSION LED US HERE" text="A More Way To Travel.We are the one stop provider for all your travel needs and requirements"></Hero>
